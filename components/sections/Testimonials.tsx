        ...
        <div className="relative w-full h-full flex justify-center items-center pointer-events-none">
          {TESTIMONIALS.map((item, index) => {
            ...
            return (
              ...
              >
                {/* 1. Brand Logo */}
                <div className={`mb-6 text-xl font-bold uppercase tracking-widest font-heading transition-all duration-500`}>
                  {item.brand}
                </div>
                ...
                <div className="relative w-full aspect-[4/5] bg-black rounded-[32px] overflow-hidden shadow-2xl border-4 border-transparent group">
                   ...
                   {/* Overlay - Dark if not active, or if active but not visible on screen */}
                ...
                {/* 3. Name */}
                <div className="mt-6 text-2xl font-normal text-gray-900 font-heading">
                  {item.name}
                </div>
              </div>
            );
